...
const dir = isProd
  ? "./dist"
  : `/Users/${useName}/Library/Containers/QReader.MarginStudyMac/Data/Library/MarginNote Extensions/marginnote.extension.mn-addon-template`
...
export default defineConfig({
  ...
  plugins: [
    ...
    copy({
      targets: [
        {
          src: ["assets/logo.png", "mnaddon.json"],
          dest: dir
        }
      ]
    })
